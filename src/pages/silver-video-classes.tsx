            ...
            <div className="relative bg-white py-16 sm:pt-24 lg:pt-32">
              <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <p className="mt-8 max-w-prose mx-auto text-xl text-gray-500">
                  ...
                  <span>
                    If you're struggling to progess in USACO, you've come to the
                    right place. Our team of past USACO Finalists have created a
                    well-structured course that will teach you all the major
                    topics of Silver in a clear and organized fashion.
                  </span>
                </p>
            ...
            <div className="relative bg-white overflow-hidden">
              ...
              <div className="relative px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg text-gray-500 mx-auto">
                  ...
                  <p>
                    This class is targeted to people who are familiar with
                    Bronze concepts. It teaches you the major concepts needed
                    for Silver. If you are already familiar with Silver
                    concepts, this class will likely be too easy for you.
                  </p>
                  <p>
            ...
            <div className="bg-white">
              <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <div className="bg-cyan-700 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
                  <div className="relative z-10 pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
